...
for i in range(number_of_points):
    ...
    print(f'Converged VQD e2 energy = {vqd_e2} with FCI error {error_fci_e2}\n')
    ...
    _his_data={f'r={r}':{'e0':his_data_e0,'e1':his_data_e1, 'e2':his_data_e2}}
